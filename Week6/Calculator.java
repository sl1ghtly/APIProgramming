...
public class Calculator extends Application{
   ...
   private GridPane getBottomPane() {
      ...
      btAdd.setOnAction(listener);
      btSubtract.setOnAction(listener);
      btMultiply.setOnAction(listener);
      btDivide.setOnAction(listener);
   ...
   class Listener implements EventHandler<ActionEvent> {
      ...
      public void handle(ActionEvent e) {
         ...
         else if (e.getSource().equals(btSubtract)) {
            // do btSubtract
            int result = num1 - num2;
            tfResult.setText("" + result);
         }
         else if (e.getSource().equals(btMultiply)) {
            // do btMultiply
            int result = num1 * num2;
            tfResult.setText("" + result);
         }
